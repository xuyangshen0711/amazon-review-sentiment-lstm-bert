...
Standalone demo for the weighted BiLSTM classifier.
Loads model.pt (weights + vocab) and predicts Positive / Negative
for Amazon-style reviews. No dataset or GloVe files needed.

NOTE: model.pt must be generated by lstm_pipeline_weighted.py.
If you see KeyError: 'vocab', re-run the training pipeline once.
"""
