...
This is the demo for the BiLSTM sentiment classifier.
It loads the saved model and predicts the sentiment
of review text.
...
If your model.pt does not include the vocab, re-run the training
pipeline once to regenerate it.
...
class BiLSTMWeightedSentiment(nn.Module):
    """Bidirectional LSTM sentiment classifier with max pooling."""
