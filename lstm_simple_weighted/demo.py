"""
CS6120 Final Project - Simple Weighted BiLSTM Sentiment Analysis Demo
Author: Xuyang Shen

==============================================================
DESCRIPTION
==============================================================
Standalone demo for the simple weighted BiLSTM classifier.
This model adds class-weighted loss (BCEWithLogitsLoss + pos_weight)
to the BiLSTM architecture, without the full balanced sampling
or threshold tuning used in the best weighted model.
...
SAMPLE_REVIEWS = [
    ...
    # Expected: Negative (negation / sarcasm — challenging case)
    ...
    # Expected: Negative (long complaint narrative)
...
# ── Model definition (must match lstm_pipeline_simple_weighted.py exactly) ────
...
def main():
    ...
    print("=" * 60)
    print("  BiLSTM Sentiment Analysis — Simple Weighted Demo")
    print("=" * 60)
    print(f"  Device : {device}")
    print(f"  Model  : Bidirectional LSTM  (simple weighted)")
