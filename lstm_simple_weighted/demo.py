...
Adds class-weighted loss to the BiLSTM architecture, without
the balanced sampling or threshold tuning used in the best model.
Loads model.pt (weights + vocab) — no dataset or GloVe files needed.

NOTE: model.pt must be generated by lstm_pipeline_simple_weighted.py.
"""
