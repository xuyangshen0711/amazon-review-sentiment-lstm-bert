...
Unidirectional 2-layer LSTM using the final hidden state, with no
class weighting or balanced sampling. Included to contrast with
the weighted BiLSTM model.

NOTE: best_lstm_model.pt must be generated by lstm_pipeline.py.
If you see KeyError: 'vocab', re-run the pipeline from the project root.
"""
